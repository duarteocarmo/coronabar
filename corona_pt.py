...
ABOUT_PAGE = "https://duarteocarmo.com/about"
...
class CoronaApp(object):
    def __init__(self):
        ...
        self.deceased = rumps.MenuItem(
            title=f"Mortos: {self.data.get('nrobitos')}"
        )
        ...
        self.about = rumps.MenuItem(title="About me", callback=self.about)
    ...
    def get_data(self, sender):
        ...
        try:
            ...
            if len(list(self.app.menu)) > 1:
                ...
                self.deceased.title = f"Mortos: {data.get('nrobitos')}"
